                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/game/allgames/add">API Game</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-6 col-sm-12 mb-2">
                                    <input type="text" v-model="searchQuery" class="form-control"
                                        placeholder="Search By Name" @keyup="filterData" />
                                </div>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-6 mb-2">
                                    <select v-model="game_type" class="form-control" @change="filterData">
                                        <option value="">All Game Type</option>
                                        <option v-for="gtype in selectedGameType" :key="gtype.id" :value="gtype.id">
                                            {{ gtype.name }}
                                        </option>
                                    </select>
                                </div>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/games/allGamesList`, {
            params: {
                page: page,
                pageSize: pageSize,
                searchQuery: searchQuery.value, //search by name
                searchGameCode: searchGameCode.value, //search by code
                selectedFilter: selectedFilter.value, //status
