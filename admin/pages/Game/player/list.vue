                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <!-- <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/game/category/add">New</LazyNuxtLink>
                                </li> -->
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-left">Show Password</th>
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-left">{{ item.playername }}</td>
                                                    <td class="text-center">{{ item.account }}</td>
                                                    <td class="text-center">{{ item.api_code }} </td>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/games/playerList`, {
            params: {
                page: page,
                pageSize: pageSize,
