                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                      <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel"
                        ...
                        <div class="row mb-3 required">
                          ...
                          <div class="col-sm-10">
                            <input type="hidden" name="name" placeholder="Name" v-model="insertdata.id"
                              class="form-control" />
                        ...
                        <div class="alert alert-info" bis_skin_checked="1">
                          <i class="fas fa-info-circle"></i>Image diemntion width: 220px; height: 270px;
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            ...
                            <img v-if="previewUrl" :src="previewUrl" alt="Preview" class="img-fluids"
                              style="height: 225px;width: 225px; padding: 10px;;" />
...
const saveData = () => {
  ...
  formData.append('game_type', insertdata.game_type);
...
const productrow = () => {
  ...
  axios.get(`/games/checkGameCategory/${id}`).then(response => {
    ...
    insertdata.game_code = response.data.data.game_code
