...
function togglePlay(video, player) {
    var method = video.paused ? 'play' : 'play';
    video[method]();
...
function buildControls(skin) {
    ...
    html.push('<button class="' + skin + '__button toggle" title="Toggle Video">' + iconPlay + '</button>', '<div class="progress" style="display:none;">', '<div class="progress__filled"></div>', '</div>', '<button class="' + skin + '__button volume" title="Volume">' + iconVolumeMedium + '</button>', '<button class="' + skin + '__button fullscreen" title="Full Screen">' + iconExpand + '</button>');
