...
var iconVolumeMute = '<i class="fa-solid fa-volume-xmark"></i>';
var iconVolumeMedium = '<i class="fa-solid fa-volume-high"></i>';
var iconVolumeLow = '<i class="fa-solid fa-volume-low"></i>';
var iconExpand = '<i class="fa-solid fa-expand"></i>';
