  ...
  return (
    ...
    <section className="game-slider">
      ...
      <Swiper
        ...
        navigation={{
          nextEl: '.Game_nxt_3', // Custom next button class
          prevEl: '.Game_prev_3', // Custom previous button class
        }} // Enable navigation
        breakpoints={{
          1280: {
            spaceBetween: 0,
...
export default GameComponenThree;