...
const PlayGame = () => {
  ...
  const getVideoEmbededurl = async (api_id) => {
    console.log("Video APPID: " + api_id);
    ...
    setIsPlaying(true); // Show the columns when API is called
            ...
            <div className="col-xl-9">
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    overflow: "hidden",
                    background: `url('/images/game_play.webp') no-repeat center`,
              ...
              <form onSubmit={handleSubmit} ref={formRef} id="yourFormId">
                ...
                {token ? (
                  <>
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <button
                          className="btn btn_signup w-100 finalyplaygame"
                          type="submit"
                          disabled={loading}
                          onClick={handlePlay}
                        >
                          <i className="fa-solid fa-play"></i>  {loading ? "Loading..." : "Play"}
                        </button>
                      </div>

                      {/* Right Column */}
                      <div className="col-md-6">
                        <button className="btn btn_signup w-100" onClick={openModal}>
                  ...
                  <>
                    <button className="btn btn-primary w-100" type="button" onClick={openModalLogin}>{loading ? "Loading..." : "Play"}</button>
                  </>
                )}
            ...
            <div className="col-xl-3 ">
              ...
              <img
                ...
                style={{
                  ...
                  margin: "10px auto",       // Add a vertical gap and center horizontally
                  maxWidth: "100%",          // Ensure responsiveness
                  borderRadius: "12px",      // Slightly more rounded corners
                  boxShadow: "0 6px 12px rgba(0, 0, 0, 0.15)", // Subtle professional shadow
                  transition: "transform 0.3s ease, box-shadow 0.3s ease", // Smooth hover effect
                  cursor: "pointer",         // Indicate clickable image
                }}
                onMouseEnter={(e) => {
                  e.target.style.transform = "scale(1.05)"; // Scale up on hover
                  e.target.style.boxShadow = "0 8px 16px rgba(0, 0, 0, 0.25)"; // Enhance shadow on hover
                }}
                onMouseLeave={(e) => {
                  e.target.style.transform = "scale(1)"; // Reset scale
                  e.target.style.boxShadow = "0 6px 12px rgba(0, 0, 0, 0.15)"; // Reset shadow
                }}
                alt="Game"
              />
