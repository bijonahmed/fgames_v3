          ...
          <div className="row">
            <div className="col-md-12">
              <div className="title_section">
                ...
                <h1 className="page_title">Bet History</h1>
              </div>
            </div>
          </div>
                ...
                <div className="col-md-8">
                  ...
                  <div className="deposit_sec balance_container">
                    ...
                    <table className="transection_table">
                      ...
                      <tbody>
                        <tr>
                          <td className=" text-light fw-bold">Newbie Lucky Spin Bonus</td>
                          <td className="text-center ">9/26/24, 2:03:05 PM</td>
                          <td className="text-center">0x</td>
                          <td>Ongoing</td>
                        </tr>
                        <tr>
                          <td className=" text-light fw-bold">Newbie Lucky Spin Bonus</td>
                          <td className="text-center ">9/26/24, 2:03:05 PM</td>
                          <td className="text-center">2.2499x</td>
                          <td>Ongoing</td>
                        </tr>
                      </tbody>
                    </table>
